H5P.InteractiveVideoInteraction = (function ($, EventDispatcher) {
  ...
  function Interaction(parameters, player, previousState) {
    ...
    var adaptivity = function ($target) {
      var adaptivity, fullScore,adaptivityId;
      ...
      if (!adaptivity || adaptivity.seekTo === undefined) {
        ...
        if (instance.hasButton !== undefined) {
          if (!instance.hasButton('iv-continue')) {
            ...
            //debugger;
            instance.addButton('h5p-question-iv-adaptivity-' + adaptivityId, adaptivity.seekLabel ? adaptivity.seekLabel : player.l10n.defaultAdaptivitySeekLabel, function () {
              if (self.isButton()) {
                // Close dialog
      ...
      instance.hideButton('iv-continue')
        .addButton('h5p-question-iv-adaptivity-' + adaptivityId, adaptivityLabel, function () {
          ...
          if (!fullScore && instance.resetTask) {
            instance.resetTask();
            instance.hideButton('h5p-question-iv-adaptivity-' + adaptivityId);
          }
      ...
      ).showButton('h5p-question-iv-adaptivity-' + adaptivityId, 1)
    ...
    self.getScore = function() {
        if ((typeof(instance) !== "undefined") && (typeof(instance.getScore) !== "undefined")) {
    ...
    self.getMaxScore = function() {
        if ((typeof(instance) !== "undefined") && (typeof(instance.getMaxScore) !== "undefined")) {
