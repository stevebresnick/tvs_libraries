...
H5P.MarkTheWords = (function ($, Question) {
  ...
  MarkTheWords.prototype.showEvaluation = function () {
    ...
    if ((this.wrongAnswers + this.missedAnswers) === 0) {
        score = this.params.behaviour.questionPoints;
    }
    ...
    var scoreText = this.params.score.replace(/@score/g, score.toString())
      .replace(/@total/g, this.params.behaviour.questionPoints.toString())
    ...
    if (score === this.params.behaviour.questionPoints) { scoreText = "Correct.  ";}
    this.setFeedback(scoreText, score, this.params.behaviour.questionPoints);

    this.triggerXAPIScored(score, this.params.behaviour.questionPoints, 'answered');
    this.trigger('resize');
    return ((this.wrongAnswers + this.missedAnswers) === 0);
  };
  ...
  MarkTheWords.prototype.getMaxScore = function () {
    return this.params.behaviour.questionPoints;
  };
