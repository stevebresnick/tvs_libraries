...
H5P.DocumentationTool = (function ($, NavigationMenu, JoubelUI, EventDispatcher) {
  ...
  DocumentationTool.prototype.adjustDocumentationToolWidth = function () {
    ...
    if ((window.thisInstance !== undefined) && (window.thisInstance.libraryInfo.machineName.toLowerCase() === "h5p.interactivevideo")) {
        this.attach(window.thisInstance.$container);
    }
