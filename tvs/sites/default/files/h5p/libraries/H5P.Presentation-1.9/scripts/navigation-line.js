var H5P = H5P || {};
H5P.Presentation = H5P.Presentation || {};

H5P.Presentation.NavigationLine = (function ($) {

  function NavigationLine(presentation) {
    this.cp = presentation;
  ...
  NavigationLine.prototype.initFooter = function () {
    ...
    if (this.cp.editor === undefined) {
      ...
      // Print button
      if (H5P.Presentation.Printer.supported()) {
        this.cp.$printButton = $('<div/>', {
          ...
          H5P.Presentation.Printer.showDialog(that.cp.l10n, $h5pWrapper, function (printAllslides) {
            H5P.Presentation.Printer.print(that.cp, $h5pWrapper, printAllslides);
          });
        });
