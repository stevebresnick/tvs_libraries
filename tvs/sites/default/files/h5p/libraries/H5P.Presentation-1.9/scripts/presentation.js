 ...
 */
H5P.Presentation = function (params, id, extras) {
  H5P.EventDispatcher.call(this);
  var that = this;
    
  this.hideProgressBar = params.generalSettings.hideProgressBar;
...
H5P.Presentation.prototype = Object.create(H5P.EventDispatcher.prototype);
H5P.Presentation.prototype.constructor = H5P.Presentation;

/**
 * @public
 */
H5P.Presentation.prototype.getCurrentState = function () {
 ...
 * @returns {undefined} Nothing.
 */
H5P.Presentation.prototype.attach = function ($container) {
  var that = this;
  ...
  $container.addClass('h5p-presentation').html(html);
  ...
  if ((this.hideProgressBar) && (this.editor === undefined)) {
  ...
  for (var i = 0; i < this.slides.length; i++) {
    slide = this.slides[i];
    $slide = H5P.jQuery(H5P.Presentation.createSlide(slide)).appendTo(this.$slidesWrapper);
    first = i === 0;
  ...
  if (this.editor !== undefined || !this.activeSurface) {
    ...
    this.navigationLine = new H5P.Presentation.NavigationLine(this);

    //this.summarySlideObject = new H5P.Presentation.SummarySlide(this, $summarySlide);
  }
  else {
      debugger;
 ...
 * @param slideScores
 */
H5P.Presentation.prototype.setProgressBarFeedback = function (slideScores) {
  var that = this;
 ...
 */
H5P.Presentation.prototype.toggleKeywords = function () {
 ...
 * Hide keywords
 */
H5P.Presentation.prototype.hideKeywords = function () {
 ...
 * Show keywords
 */
H5P.Presentation.prototype.showKeywords = function () {
  if (this.$keywordsButton !== undefined) {
 ...
 */
H5P.Presentation.prototype.setKeywordsOpacity = function (value) {
  var self = this;
 ...
 * @returns {undefined}
 */
H5P.Presentation.prototype.fitCT = function () {
 ...
 * @returns {undefined}
 */
H5P.Presentation.prototype.resize = function () {
  ...
  // TODO: Add support for -16 when content conversion script is created?
    if (width === 0) {
      if (/(13D15)/g.test( navigator.userAgent ) === true)  {
        width = 900;  
      }
      if (width === 0) {
 ...
 */
H5P.Presentation.prototype.toggleFullScreen = function () {
 ...
 * Set focus.
 */
H5P.Presentation.prototype.focus = function () {
  this.$wrapper.focus();
};
 ...
 * @returns {undefined}
 */
H5P.Presentation.prototype.keywordClick = function ($keyword) {
 ...
 * @param {Number} index
 */
H5P.Presentation.prototype.addElements = function (slide, $slide, index) {
 ...
 * @returns {unresolved}
 */
H5P.Presentation.prototype.addElement = function (element, $slide, index) {
  var instance;
  if (element.action === undefined) {
    // goToSlide, internal element
    instance = new H5P.Presentation.GoToSlide(element.title, element.goToSlide, element.invisible, this);
  }
  else {
    // H5P library
    var defaults;
    if ((this.overrideButtons) && (element.action.library.toLowerCase().indexOf("h5p.summary") !== 0)) {
      defaults = {
        params: {
          behaviour: {
 ...
 * @param {Number} index
 */
H5P.Presentation.prototype.attachElements = function ($slide, index) {
 ...
 * @returns {jQuery}
 */
H5P.Presentation.prototype.attachElement = function (element, instance, $slide, index) {
  var that = this;
 ...
 */
H5P.Presentation.prototype.resizePopupImage = function ($wrapper) {
 ...
 * @returns {undefined}
 */
H5P.Presentation.prototype.addElementSolutionButton = function (element, elementInstance, $elementContainer) {
  var that = this;
 ...
 * @returns {undefined}
 */
H5P.Presentation.prototype.showPopup = function (popupContent, remove, classes) {
  var doNotClose;
  var self = this;
 ...
 *  false otherwise
 */
H5P.Presentation.prototype.checkForSolutions = function (elementInstance) {
 ...
 * @returns {String} HTML.
 */
H5P.Presentation.prototype.keywordsHtml = function (keywords, first) {
  var html = '';
 ...
 */
H5P.Presentation.prototype.initKeywordsList = function (keywords) {
  var that = this;
 ...
 * @returns {undefined} Nothing.
 */
H5P.Presentation.prototype.initKeyEvents = function () {
 ...
 * @returns {undefined} Nothing.
 */
H5P.Presentation.prototype.initTouchEvents = function () {
  var that = this;
 ...
 * @param yPos
 */
H5P.Presentation.prototype.updateTouchPopup = function ($container, slideNumber, xPos, yPos) {
 ...
 */
H5P.Presentation.prototype.previousSlide = function (noScroll) {
 ...
 * @returns {Boolean} Indicates if the move was made.
 */
H5P.Presentation.prototype.nextSlide = function (noScroll) {
 ...
 */
H5P.Presentation.prototype.attachAllElements = function () {
 ...
 */
H5P.Presentation.prototype.jumpToSlide = function (slideNumber, noScroll) {
  var that = this;
  if (this.editor === undefined) {
    
    var extra = { "http://apppublisher.biz/x-api/slide-navigated-to" : (slideNumber+1).toString()};
    this.triggerXAPI('progressed',extra);
  }
 ...
 */
H5P.Presentation.isiPad = navigator.userAgent.match(/iPad/i) !== null;
 ...
 * @returns {String} HTML.
 */
H5P.Presentation.createSlide = function (slide) {
 ...
 * @public
 */
H5P.Presentation.prototype.resetTask = function () {
 ...
 * @returns {undefined}
 */
H5P.Presentation.prototype.showSolutions = function () {
 ...
 */
H5P.Presentation.prototype.getSlideScores = function (noJump) {
 ...
 */
H5P.Presentation.prototype.getCopyrights = function () {
 ...
 * @param {object} instance
 */
H5P.Presentation.prototype.pauseMedia = function (instance) {
  try {
