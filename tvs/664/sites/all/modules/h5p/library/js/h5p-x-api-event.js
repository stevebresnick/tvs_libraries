...
H5P.XAPIEvent.prototype.setObject = function (instance,verb) {
  if (instance.contentId) {
    ...
    try {
        if ((instance.libraryInfo.machineName === "H5P.SingleChoiceSet") || (instance.libraryInfo.machineName === "H5P.SingleChoiceSetColl")) {
     ...
     try {
        if ((instance.libraryInfo.machineName === "H5P.DragQuestion") || (instance.libraryInfo.machineName === "H5P.DragQuestionColl")) {
            debugger;
            ...
            var answersGiven = "";
            for (var i = 0; i < instance.options.question.task.dropZones.length; i++) {
                for (var j = 0; j < instance.options.question.task.dropZones[i].correctElements.length; j++) {
                    if (answersGiven !== "") { answersGiven += "|-|";}
                    
                    var correctElement = Number(instance.options.question.task.dropZones[i].correctElements[j]);
                
                    if (instance.options.question.task.elements[correctElement].type.library.toLowerCase().indexOf("h5p.advancedtext") > -1) {
                        answersGiven += instance.options.question.task.elements[correctElement].type.params.text;
                    }
                }
            }
            ...
            var isCorrect = false;
            if ((instance.rawMax > 0) && (instance.rawMax === instance.rawPoints)) {
                isCorrect = true;
            }

            this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/is-answer-correct'] = isCorrect.toString();
        }
    }
    catch (ex) {
    ...
    try {
        if ((instance.libraryInfo.machineName === "H5P.Blanks") || (instance.libraryInfo.machineName === "H5P.BlanksColl")) {
    ...
    try {
        if ((instance.libraryInfo.machineName === "H5P.MultiChoice") || (instance.libraryInfo.machineName === "H5P.MultiChoiceColl")) {
            ...
            var isCorrect = false;
            if ((instance.getMaxScore() > 0) && (instance.getMaxScore() === instance.getScore())) {
                isCorrect = true;
            }
    ...
    try {
        if ((instance.libraryInfo.machineName === "H5P.MarkTheWords") || (instance.libraryInfo.machineName === "H5P.MarkTheWordsColl")) {
    ...
    try {
        if ((instance.libraryInfo.machineName === "H5P.Summary") || (instance.libraryInfo.machineName === "H5P.SummaryColl")) {
    ...
    try {
        if (typeof(instance.libraryInfo) === "undefined") {
            
            
            if (typeof(instance.selectableWords) !== "undefined") {
                this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/question-asked'] = instance.params.taskDescription.replace("<div>","").replace("</div>","").replace("\n","").replace("<p>","").replace("</p>","");
                var answersGiven = "";
                var areAnswersCorrect = true;
                for (var mmI=0; mmI < instance.selectableWords.length; mmI++) {
            ...
            else if (typeof(instance.summaries) !== "undefined") {
                this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/question-asked'] = instance.options.intro.replace("<div>","").replace("</div>","").replace("\n","").replace("<p>","").replace("</p>","");
                if (verb.toLowerCase() === "answered") {
                    this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/answer-provided'] = instance.summaries[0].summary[0].replace("<div>","").replace("</div>","").replace("\n","").replace("<p>","").replace("</p>","");
                    this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/is-answer-correct'] = "true";
            ...
            else if (typeof(instance.clozes) !== "undefined") {
                this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/question-asked'] = instance.params.questions[0].replace("<div>","").replace("</div>","").replace("\n","").replace("<p>","").replace("</p>","").replace('<span class=\"h5peditor-nicEditor-placeholder\">','').replace('</span>','');
                var answersProvided = "";
                for (var i = 0; i < instance.clozes.length; i++) {
                    if (answersProvided !== "") { answersProvided += ","; }
                    answersProvided += instance.clozes[i].getUserAnswer();
                ...
                if (instance.clozes.length > 0) {
                    this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/is-answer-correct'] = instance.clozes[0].correct().toString();
                }
            }
            else if (typeof(instance.actionData) !== "undefined") {
                this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/question-asked'] = instance.actionData.questionAsked.replace("<div>","").replace("</div>","").replace("\n","").replace("<p>","").replace("</p>","");
                this.data.statement.object.definition.extensions['http://apppublisher.biz/x-api/answer-provided'] = instance.actionData.answerProvided.replace("<div>","").replace("</div>","").replace("\n","").replace("<p>","").replace("</p>","");
