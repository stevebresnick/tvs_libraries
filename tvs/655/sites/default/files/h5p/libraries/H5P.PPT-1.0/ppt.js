...
(function ($) {
  ...
  H5P.PPT.prototype.attach = function ($wrapper) {
    ...
    if (window.location.host.toLowerCase().indexOf("showpad.biz") > 0) {
        url = window.location.protocol + "//" + window.location.host + this.params.files.path.replace("indexc.html","").replace("http://","https://").replace(".pptx", "/index.html").replace(".ppt", "/index.html");
    }
