...
H5P.ImageHotspots = (function ($, EventDispatcher) {
  ...
  function ImageHotspots(options, id) {
    ...
    if (this.options.menu.hotspots === undefined) {
        this.options.menu.hotspots = this.options.menu.settings.hotspots;
    }
  ...
  ImageHotspots.prototype.attach = function ($container) {
    ...
    H5P.jQuery(".h5p-enable-fullscreen").click(function(){
        H5P.fullscreen(this.$container, this);
    });
    
    if (this.options.menu.settings.image !== undefined && this.options.menu.settings.image !== null) {
        this.options.image = this.options.menu.settings.image;
        this.options.color = this.options.menu.settings.color;
    }
     
    if (this.options.menu.hotspots !== undefined && this.options.menu.hotspots !== null) {
        this.options.hotspots = this.options.menu.hotspots;
    }
