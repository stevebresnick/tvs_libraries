  ...
  function Question(type) {
    ...
    self.setImage = function (path, options) {
      ...
      var $imgWrap = $('<div/>', {
        ...
        var trueImgPath = H5P.getPath(path, self.contentId).replace("file:///", "./");
    ...
    self.setFeedback = function (content, score, maxScore) {
      if (content !== undefined) {
          H5P.jQuery(".h5p-question-content")[0].style.height="100%";
      }
     ...
     * @param {H5P.jQuery} $container
     */
    self.attach = function ($container,mleSubLibrary) {
      if (typeof(mleSubLibrary) === "undefined") {
          mleSubLibrary = null;
      }
        
        
      if ((self.isRoot !== undefined) && (self.isRoot())) {
      ...
      // Prepare container
      $wrapper = $container;
      $container.html('').attr('role', 'application').addClass('h5p-question h5p-' + type);
      ...
      var libraryType = "";
      if (self.library !== undefined) {
          libraryType = self.libraryInfo.machineName;
      }
      if ((mleSubLibrary !== null) && (libraryType === "")) {
          libraryType = mleSubLibrary;
      }
